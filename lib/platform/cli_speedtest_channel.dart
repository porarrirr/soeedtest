...
class CliSpeedtestChannel {
  ...
  Future<NativeSpeedtestResult> startTest({
    required List<String> providerOrder,
  }) async {
    final Map<dynamic, dynamic>? result = await _methodChannel
        .invokeMapMethod<dynamic, dynamic>("startCliTest", <String, dynamic>{
          "providerOrder": providerOrder,
        });
    if (result == null) {
      throw PlatformException(
        code: "no_result",
        message: "Native CLI speed test returned no result",
      );
    }
  ...
  Future<void> cancelTest() async {
    await _methodChannel.invokeMethod<void>("cancelCliTest");
  }
}
